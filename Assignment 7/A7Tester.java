...
public class A7Tester {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Testing " + (testLinked ? "LinkedList" : (testHash ? "HashTable" : "BinarySearchTree")) + " implementation.");
  ...
  static void add_key_values(HashMap <String, Integer> hm, String keys[], int[] values, int count) {
